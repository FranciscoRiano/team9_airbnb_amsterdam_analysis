...
This research focuses on price analysis of AirBnB in Amsterdam, the Netherlands between 2012 and 2019. Therefore, only data from Amsterdam in 2012-2019 were downloaded form the website. what info data contain... Number of observations ... Missing values ... The downloaded files were stored in Google Drive to ensure the same dataset can be also accessed in the future. To download the data see data/download_data.R.
